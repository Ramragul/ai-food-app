...
//             "Workout assigned",
//           description:
//             `${templateName} has been assigned successfully.`,
//           status:
//             "success",
//           duration:
//             3000,
...
//                   color="gray.500"
//                 >
//                   Create a client-specific training plan.
//                 </Text>
...
//                 mb={4}
//               >
//                 Choose the days this workout should be followed.
//               </Text>
...
//                   ? `${scheduledDays.length} training day${
