...
import MyClientNutritionCard from "../../components/StaffUI/Clients/MyClientNutritionCard";
import MyClientPermissions from "../../components/StaffUI/Clients/MyClientPermissions";
import MyClientWorkoutCard from "../../components/StaffUI/Clients/MyClientWorkoutCard";
    ...
    return (
        <>
            ...
            >
                ...
                {/* Workout management sits outside the consent-gated health-data area. */}
                <MyClientWorkoutCard
                    memberId={Number(memberId)}
                />
                ...
                {client.consent.granted ? (
                    ...
                    >
                        ...
                        <Box mt={8} color="blue.600" fontWeight="600">
                            Waiting for client approval...
                        </Box>
